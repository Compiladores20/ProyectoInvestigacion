...
public class Juego_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void Tecla(int valor) {
        ...
        if (previos != null) {
            ...
            if (valor == 6) {
                ...
                getLang(string.replaceAll("\\(\\)",""));
            }
        }
    }
    public void getLang(String pExp){
        TextView txt = (TextView) findViewById(R.id.textView8);
        String[] genOut = generadorERYL.GeneradorJuego2(pExp).split("#");
        String pTVText = "";
        for (int i  = 0; i < genOut.length;i++){
    ...
    private void initKeyboard() {
        //Inicializamos los botones del teclado.
